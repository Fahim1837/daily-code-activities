...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">28 Feb, 2025 | 12:09 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">3016ab5</code>
**Message:** useSignupRedux setup done
**Description:**
- useSignupRedux setup done
---
