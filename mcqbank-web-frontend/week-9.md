...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">06 Mar, 2025 | 07:35 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">e474f1d</code>
**Message:** Recovery Email Sending Part is Done
**Description:**
- Recovery Email Sending Part is Done
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">06 Mar, 2025 | 05:10 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">e5dbddd</code>
**Message:** Forget Password Section Done
**Description:**
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">06 Mar, 2025 | 07:54 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">da611cd</code>
**Message:** New Password Page setup Successful
**Description:**
- New Password Page setup Successful
---
