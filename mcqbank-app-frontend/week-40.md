...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">08 Oct, 2025 | 10:55 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">11f99db</code>
**Message:** Sidebar active and hover links color fixed
**Description:**
- Sidebar active and hover links color fixed
---
