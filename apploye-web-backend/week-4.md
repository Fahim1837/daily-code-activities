...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Jan, 2025 | 12:58 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">35c7b0b3</code>
**Message:** Update Feature of Invoice- Client fixed
**Description:**
- Update Feature of Invoice- Client fixed
---
