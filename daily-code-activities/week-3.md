...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">19 Jan, 2025 | 07:34 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">f0f07ae</code>
**Message:** Test Commit
**Description:**
- Test Commit
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">19 Jan, 2025 | 07:36 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">f999fb9</code>
**Message:** Test Commit
**Description:**
- Test Commit
---
