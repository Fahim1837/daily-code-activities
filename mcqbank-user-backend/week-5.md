...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">05 Feb, 2025 | 02:06 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">86a8f30</code>
**Message:** Minor UI issues
**Description:**
- Minor UI issues
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">05 Feb, 2025 | 02:09 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">2be54ca</code>
**Message:** Link Issues
**Description:**
- Link Issues
---
