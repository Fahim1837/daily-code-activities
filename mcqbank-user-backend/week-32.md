...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">15 Aug, 2025 | 08:17 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">e47d8ce</code>
**Message:** APIs endpoints for Images are created
**Description:**
- APIs endpoints for Images are created
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">15 Aug, 2025 | 08:26 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">e08b239</code>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">15 Aug, 2025 | 08:30 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">cd34f4d</code>
**Message:** Image View is included from git
**Description:**
- Image View is included from git
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">15 Aug, 2025 | 10:41 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">7d50afb</code>
**Message:** Image related issue completely solved
**Description:**
- Image related issue completely solved
---
