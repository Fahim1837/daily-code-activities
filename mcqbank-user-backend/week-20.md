...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">23 May, 2025 | 05:07 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">a2f3f46</code>
**Message:** Error Handles are now more structured
**Description:**
- Error Handles are now more structured
---
