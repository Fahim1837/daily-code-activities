...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">02 May, 2025 | 12:40 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">b234372</code>
**Message:** Some changes occured
**Description:**
- Some changes occured

- validate_phone is redefined
- new url all-members-latest-clockin/ added
- get_querset and get_employee_list redefined
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">02 May, 2025 | 12:45 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">518dd16</code>
**Message:** Mistakenly skipped
**Description:**
- Mistakenly skipped
---
