...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">23 Jan, 2025 | 10:39 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">9ce78965</code>
**Message:** Idle Slot Color Changed
**Description:**
- Idle Slot Color Changed
---
