...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">06 Feb, 2025 | 04:32 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">54ac626b</code>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">07 Feb, 2025 | 10:47 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">decce535</code>
**Message:** Validation Error correctly shown
**Description:**
- Validation Error correctly shown
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">07 Feb, 2025 | 12:26 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">c17f2f1c</code>
**Message:** UI fixed completely
**Description:**
- UI fixed completely

- Border is used around the input
- Cancel Button is used
- Cancel Button is formatted
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">07 Feb, 2025 | 05:05 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">02aa811a</code>
**Message:** Cancel Button Functionality fixed
**Description:**
