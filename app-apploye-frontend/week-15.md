...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">18 Apr, 2025 | 09:44 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">167a6287</code>
**Message:** Merge branch 'dev' into activity-name
**Description:**
- Merge branch 'dev' into activity-name
---
