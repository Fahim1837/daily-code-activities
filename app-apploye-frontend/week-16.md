...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">23 Apr, 2025 | 12:10 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">d39b0f76</code>
**Message:** Works well on all cases
**Description:**
- Works well on all cases
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">23 Apr, 2025 | 12:11 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">bfb42408</code>
**Message:** Merge branch 'approval-accept-all' into staging
**Description:**
- Merge branch 'approval-accept-all' into staging
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">23 Apr, 2025 | 03:46 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">4d2097d5</code>
**Message:** Lands on Activity Report Page with Me filter
**Description:**
- Lands on Activity Report Page with Me filter

- The hyphen bar color changed
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">23 Apr, 2025 | 03:55 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">151f8d7e</code>
**Message:** Merge branch 'dashboard-activity' into staging
**Description:**
- Merge branch 'dashboard-activity' into staging
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
      <h3 style="margin: 0; padding:0; font-weight: bold; font-size:20px;">invoice-not-removed</h3>
  </div>
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">24 Apr, 2025 | 10:38 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">8330038b</code>
**Message:** Edit Invoice will catch errors similar to Create invoice
**Description:**
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">24 Apr, 2025 | 10:47 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">3846f0f3</code>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">24 Apr, 2025 | 10:48 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">aba691820</code>
**Message:** env files for local is added
**Description:**
- env files for local is added
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">24 Apr, 2025 | 02:33 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">ed16cbe9</code>
**Message:** Approval sheet will update only, no refetching occurs
**Description:**
- Approval sheet will update only, no refetching occurs
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">24 Apr, 2025 | 08:22 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">28e1466a</code>
**Message:** All Notes pagination works somewhat
**Description:**
- All Notes pagination works somewhat

- Needs click for paginated response
- Single Notes disappeared... Needs fixes
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 09:40 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">e254e650</code>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 10:37 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">55f06684</code>
**Message:** Warning Toast Message added
**Description:**
- Warning Toast Message added
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 11:52 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">99d5798b</code>
**Message:** Bottom Pagination added to all notes modal
**Description:**
- Bottom Pagination added to all notes modal
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 12:08 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">0ef76664</code>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 12:13 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">7a7567c9</code>
**Message:** Pagination limit changed to 50
**Description:**
- Pagination limit changed to 50
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 12:21 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">f7f972ce</code>
**Message:** clear states when modal closed
**Description:**
- clear states when modal closed
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 02:52 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">e57981dc</code>
**Message:** Response object in sagas is changed
**Description:**
- Response object in sagas is changed

- Corresponding changes are made to make the work done
- Prettier applied here
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 03:06 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">fc87dca5</code>
**Message:** Temporary Commit
**Description:**
- Temporary Commit
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 03:35 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">7df53fa5</code>
**Message:** Temp Commit
**Description:**
- Temp Commit
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 03:59 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">8b3c33e3</code>
**Message:** Issue on invalid date for Failed PATCH request solved
**Description:**
- Issue on invalid date for Failed PATCH request solved
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">25 Apr, 2025 | 05:24 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">493cb46e</code>
**Message:** Concurrency Issue Solved
**Description:**
