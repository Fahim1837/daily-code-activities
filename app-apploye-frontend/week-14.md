...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">11 Apr, 2025 | 05:23 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">f1e3b988</code>
**Message:** Date Format will now change even though organization changes
**Description:**
- Date Format will now change even though organization changes
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">11 Apr, 2025 | 05:32 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">6ff52527</code>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">11 Apr, 2025 | 05:33 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">00e589cd</code>
**Message:** Merged with the staging branch
**Description:**
