<h1 style="text-align:center; margin-bottom:10px">Week-17</h1>
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 03:54 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">362b8b6</code>
**Message:** selectNextWeek function defined
**Description:**
- selectNextWeek function defined
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 03:55 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">852cedf</code>
**Message:** New GoogleCalenderPopup created in the page
**Description:**
- New GoogleCalenderPopup created in the page
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 04:05 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">5df960a</code>
**Message:** Some spaces removed
**Description:**
- Some spaces removed
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 04:10 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">c6751f5</code>
**Message:** Org popup will have two letters from now on
**Description:**
- Org popup will have two letters from now on
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 04:35 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">c44fc3a</code>
**Message:** Only Pricing Plan added in the file
**Description:**
- Only Pricing Plan added in the file

- Rest are quotations and spaces
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 04:39 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">85789d0</code>
**Message:** Immense Changes
**Description:**
- Immense Changes
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 04:50 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">54cf42d</code>
**Message:** Components required for timesheet page are collected
**Description:**
- Components required for timesheet page are collected
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/amazon.svg" alt="Amazon Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2025 | 04:59 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">521ff84</code>
**Message:** Compile Error Solved
**Description:**
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">27 Apr, 2026 | 09:56 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">3131e64ee</code>
**Message:** Sync Button Added. Need some fixes after data is obtained
**Description:**
...
<div style="display: flex; justify-content: space-between; align-items:end;">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">27 Apr, 2026 | 12:45 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">7882bfb17</code>
**Message:** Just code is shifted. Nothing else
**Description:**
- Just code is shifted. Nothing else
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">27 Apr, 2026 | 04:47 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">350fc7061</code>
**Message:** All issues on Edit Invoice Page except Job is resolved
**Description:**
- All issues on Edit Invoice Page except Job is resolved
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">28 Apr, 2026 | 09:34 AM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">6a9a4d533</code>
**Message:** Most of Editing Invoice Issues are resolved
**Description:**
- Most of Editing Invoice Issues are resolved
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">28 Apr, 2026 | 12:58 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">6e96cb936</code>
**Message:** Edit Invoice Working as Intended
**Description:**
- Edit Invoice Working as Intended

- Selecting Job brings in new Line Items
-  Create Invoice Working correctly
- Job is loaded during page load.
- Changing client removes job
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2026 | 04:25 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">cc27fb323</code>
**Message:** Delete and Create is working. But need some more testings
**Description:**
- Delete and Create is working. But need some more testings
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2026 | 05:25 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">75570512a</code>
**Message:** Pagination and  InvoiceList Update working
**Description:**
- Pagination and  InvoiceList Update working
---
<div style="display: flex; justify-content: space-between; align-items:end;">
  <div style="display:flex">
      <img src="../assets/branch.svg" alt="GitHub Logo"  style="width:20px; margin:0 10px 0 0">
  ...
  <div style="display:flex">
  <img src="../assets/github.svg" alt="GitHub Logo" style="width:20px">
    <span style="color:rgb(16, 54, 226); text-align: right; margin:0 0 0 10px; padding:0px;">29 Apr, 2026 | 07:46 PM</span>
  </div>
</div>

**_Commit:_** <code style="color: red; font-weight: bold;">180dedf4b</code>
**Message:** Client Short URL changed
**Description:**
- Client Short URL changed
---
